  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <p className="mb-4">
          For more information about our privacy practices, if you have questions, or if you would like to make a complaint, please contact us by email at <a href="mailto:pkmurshad236@gmail.com" className="text-blue-500 hover:underline">pkmurshad236@gmail.com</a> or by mail using the details provided below:
        </p>
