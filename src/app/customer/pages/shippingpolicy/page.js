...
const ShippingPolicy = () => {
  return (
    <>
      <Head>
        <title>Shipping Policy - murshadpk.com</title>
      </Head>
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <p className="mb-8">
          murshadpk.com is not liable for any products damaged or lost during shipping. If you received your order damaged, please contact the shipment carrier to file a claim. Please save all packaging materials and damaged goods before filing a claim.
        </p>

        <h2 className="text-2xl font-semibold mb-4">9. Contact Us</h2>
        <p className="mb-4">
          If you have any questions about these terms and conditions, please contact us at <a href="pkmurshad236@gmail.com" className="text-blue-500 hover:underline">pkmurshad236@gmail.com</a> or by mail at:
        </p>
