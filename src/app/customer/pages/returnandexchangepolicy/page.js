  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <p className="mb-8">
          We only replace items if they are defective or damaged. If you need to exchange an item for the same product, please contact us at <a href="mailto:pkmurshad236@gmail.com" className="text-blue-500 hover:underline">pkmurshad236@gmail.com</a>.
        </p>

        <h3 className="text-xl font-semibold mb-2">Exchange Process:</h3>
        <ol className="list-decimal list-inside mb-8">
          <li className="mb-2">To initiate an exchange, please contact our customer support team at <a href="mailto:exchanges@murshadpk.com.ca" className="text-blue-500 hover:underline">pkmurshad236@gmail.com</a> with your order number, details of the defect or damage, and any supporting photos.</li>
